...
export const skillItems = [
  ...
  export const gridItems = [
    {
      id: 1,
      title: "I prioritize clear and consistent communication to bring their ideas to life",
      description: "",
  ...
  export const workExperience = [
   ...
   
    {
      ...
      desc: "Managed the end-to-end development of a web project for a client, from initial brainstorming sessions to live deployment.",
      className: "md:col-span-2", 
      thumbnail: "/exp4.svg",
    },
  ];
