...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    if (copied) return;
    const text = "suhasledange10@gmail.com";
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        <div className="w-full h-full absolute">
          {img && (
            <Image
              ...
              className={cn(
                imgClassName,
                "opacity-90 saturate-[0.8] object-cover object-center"
              )}
            />
          )}
        </div>
        ...
        >
          ...
          {id === 3 && (
            <div className="flex items-center justify-center gap-8 flex-wrap max-w-sm mx-auto">
              {skillItems.map((item) => (
